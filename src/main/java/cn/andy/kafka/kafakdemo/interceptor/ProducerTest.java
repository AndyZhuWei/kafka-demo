...
public class ProducerTest {
    ...
    public static void main(String[] args) {
        ...
        interceptors.add("cn.andy.kafka.kafakdemo.interceptor.TimeStampPrependerInterceptor");
        interceptors.add("cn.andy.kafka.kafakdemo.interceptor.CounterInterceptor");

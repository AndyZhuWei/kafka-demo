package cn.andy.kafka.kafakdemo.producer;
...
public class ProducerTest {
    ...
    public static void main(String[] args) {
        ...
        //acks=all或-1 表示当发送消息时，leader broker不仅会将消息写入本地日志，同时还会等待ISR中所有其他副本都成功写入他们各自的本地日志后，
        // 才发送响应结果给producer.
        //显然当设置acks=all，只要ISR中至少有一个副本处于”存活“状态的，那么这条消息就肯定不会丢失，因而可以达到最高的消息持久性，
        // 但通常这种设置下producer的吞吐量也是最低的
